<?php
    $mysqlExists = false;
    if(function_exists("mysql_connect")) $mysqlExists = true;

    $ssh2Exists = false;
    if(function_exists("ssh2_connect")) $ssh2Exists = true;

    $gdExists = false;
    if(function_exists("gd_info")) $gdExists = true;

    $modRewriteExists = false;
    if(in_array('mod_rewrite', apache_get_modules())) $modRewriteExists = true;
?>
<html>
<head>
	<meta charset="utf8">
